...
CREATE TABLE `prd_category` (
	`prd_category_code`	int	NOT NULL	COMMENT '상품카테고리코드',
	`prd_category_name`	varchar(100)	NOT NULL	COMMENT '상품카테고리명',
...
# AUTO_INCREMENT 추가
ALTER TABLE `product` MODIFY  `product_code` int AUTO_INCREMENT;
ALTER TABLE `prd_category` MODIFY  `prd_category_code` int AUTO_INCREMENT;
